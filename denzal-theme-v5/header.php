...
<div class="topbar">
    <div class="container">
        <span class="topbar-left">📍 Serving NEPA: Scranton, Wilkes-Barre, Lackawanna &amp; Luzerne Counties</span>
        <div class="topbar-right">
            <a href="mailto:info@denzalconstruction.com">
...
<header class="site-header" id="site-header">
        ...
        <div class="header-inner">
            <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="site-logo" aria-label="<?php bloginfo( 'name' ); ?> Home">
                <img src="https://denzalconstruction.com/wp-content/uploads/2019/03/DenZal_Logo-2-MED-1024x593.png"
                     alt="<?php bloginfo( 'name' ); ?>" width="180" height="48" />
            </a>

            <nav class="primary-nav" aria-label="Primary">
                <?php wp_nav_menu( [ 'theme_location' => 'primary', 'container' => false, 'menu_class' => '', 'depth' => 1, 'fallback_cb' => 'denzal_fallback_nav' ] ); ?>
            </nav>
    ...
    <div class="mobile-nav" id="mobile-nav" role="navigation" aria-label="Mobile">
        <?php wp_nav_menu( [ 'theme_location' => 'primary', 'container' => false, 'menu_class' => '', 'depth' => 1, 'fallback_cb' => 'denzal_fallback_nav' ] ); ?>
